            ...
            children: [
              SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Center(
                      child: Text(
                        '${snapshot.data!.appName[0].toUpperCase()}${snapshot.data!.appName.substring(1)}',
                    ...
                    builder:
                        (
                          ...
                          for (int i = 0; i < snapshot.data!.length; i++) {
                            for (final String package
                                in snapshot.data![i].packages) {
                              if (!mappings.containsKey(package)) {
                                mappings[package] = [];
                              }

                              mappings[package].add(
                                snapshot.data![i].paragraphs
                                              ...
                                              Center(
                                                child: SizedBox(
                                                  ...
                                                  child: ListView.builder(
                                                    ...
                                                    itemCount:
                                                        correspondingLicenses
                                                            .length,
                                                    itemBuilder:
                                                        (_, int index) => Text(
                                                          '${correspondingLicenses[index]}\n\n',
                                                        ),
                                                  ),
                                                ),
                                              ),
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${licenses[num]['licenses'].length} License${licenses[num]['licenses'].length > 1 ? 's' : ''}',
                                        ),
                                      ],
                                    ),
                                  ),
              ...
              Align(
                ...
                child: Container(
                  ...
                  color: themeCached.colorScheme.surface,
                  width: mediaQueryCached.size.width,
                  child: Center(child: const Text('Powered by Flutter')),
                ),
              ),
            ],
          ),
